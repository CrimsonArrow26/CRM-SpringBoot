...
public class ActivityService {
    ...
    @Transactional(readOnly = true)
    public Page<ActivityDto> getActivitiesByOrganizationPaginated(Long orgId, String type,
        ...
        if (search != null && !search.isBlank()) {
            page = activityRepository.findByOrganizationWithSearch(organization, search, pageable);
        } else if (type != null && !type.isBlank()) {
            page = activityRepository.findByOrganizationAndType(organization, type, pageable);
        } else if (status != null && !status.isBlank()) {
            page = activityRepository.findByOrganizationAndStatus(organization, status, pageable);
        } else {
            page = activityRepository.findByOrganizationWithRelations(organization, pageable);
        }
